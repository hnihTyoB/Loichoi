export const AUDIT_ACTION = {
  ...
  APPROVE_IMPORT_DRAFT: 'APPROVE_IMPORT_DRAFT',
  REJECT_IMPORT_DRAFT: 'REJECT_IMPORT_DRAFT',
  BULK_APPROVE_IMPORT: 'BULK_APPROVE_IMPORT',
  REPROCESS_IMPORT_JOB: 'REPROCESS_IMPORT_JOB',
} as const;
